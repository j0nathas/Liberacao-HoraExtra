...
export default function FormView({
    ...
    return (
        <main className="flex-1 grid grid-rows-[10%_90%] overflow-hidden">
            {forms.length > 1 && (
            ...
            <section className="w-full h-full flex items-center justify-center mx-auto px-4 lg:px-10 py-4 overflow-auto">
                <form onSubmit={handleSubmit} className="max-w-7xl self-center flex flex-col gap-1">

                    <div className=" grid grid-cols-1 lg:grid-cols-3 gap-6">
                        {/* Card 1: Motivos e Local */}
                        <div className={`bg-white rounded-2xl shadow-sm border border-gray-200 transition-all flex flex-col overflow-hidden 
                            ${primeiroCardPreenchido ? 'border-blue-500 shadow-md shadow-blue-100' : 'border-gray-200'}`}>
                            <div className={`bg-slate-50 px-6 py-4 border-b border-slate-200 flex items-center relative gap-2 text-slate-700 font-semibold`}>
                            ...
                            <div className="p-6 flex-1">
                                ...
                                <div className="space-y-2">
                                    ...
                                    {currentForm.funcionarios.length > 0 && (
                                        <div className="flex items-center gap-1.5 mt-2 text-amber-600 bg-amber-50 p-2 rounded-lg border border-amber-100">
                        ...
                        <div className={`bg-white rounded-2xl border-slate-200 shadow-sm border transition-all flex flex-col lg:col-span-1 overflow-hidden 
                            ...
                            <div className={`p-6 space-y-4 flex-1 ${!liberarTerceiroCard ? 'pointer-events-none select-none' : ''}`}>
                                ...
                                <div className="space-y-2 bg-slate-50 p-1 rounded-2xl h-[200px] [&::-webkit-scrollbar-button]:hidden overflow-y-auto pr-1 custom-scrollbar">
                                    {currentForm.funcionarios.length > 0 ? (
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4 mt-4 px-6 py-4 bg-white rounded-2xl border border-slate-200 shadow-sm">
